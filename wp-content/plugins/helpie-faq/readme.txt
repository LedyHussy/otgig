...
Tags: faq, accordion, docs, woocommerce faq, gutenberg faq, faq widget, faq schema, elementor, faq, accordions, toggle
...
Accordion & FAQ builder for WordPress with powerful Drag and Drop features. Helpie Accordion FAQ plugin has Elementor & Woocommerce integration. Has Docs, Gutenberg block, FAQ Schema, FAQ Search, Shortcodes, Widgets. 

== Description ==
Accordion & FAQ - Helpie FAQ is an advanced WordPress FAQ Plugin for effortlessly creating, editing, and embedding FAQs and Accordions on your WordPress website. You can create a stunning Docs pages easily (Coming Soon).
...
Helpie FAQ plugin can be integrated with <a href='http://helpiewp.com/'>**Helpie Knowledge base plugin** </a> and the knowledge base categories can be used for FAQs. This can help add a FAQ section to your knowledge base based on categories. 
...
9. User Submission (PRO) - Allow users to submit their questions
10. Add custom icons to FAQ Toggle (PRO)
11. FAQs customized with Premium Styling Options (PRO)
12. Related FAQ categories with Woo product categories/all products (PRO)
13. FAQ Insights to understand customers better (PRO)
