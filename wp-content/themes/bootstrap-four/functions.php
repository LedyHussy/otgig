...
if ( ! function_exists( 'bootstrap_four_theme_styles' ) ) :
  function bootstrap_four_theme_styles() {
    ...
    wp_register_style( 'bootstrap-four-bootstrap', get_template_directory_uri() . '/css/bootstrap.css', array(), $bootstrap_four_version );
    wp_enqueue_style( 'bootstrap-four-styles', get_stylesheet_uri(), array( 'bootstrap-four-bootstrap' ), '1' );
    wp_enqueue_style( 'person-style', get_template_directory_uri() . '/css/index.css', array() );
  }
endif;
